...
namespace QLMucTieu
{
	public class clsTabHaiQuan : clsDBInteractionBase
	{
		...
		public override bool Insert()
		{
			...
			scmCmdToExecute.CommandText = "dbo.[pr_tabHaiQuan_Insert]";
			...
			catch(Exception ex)
			{
				...
				throw new Exception("clsTabHaiQuan::Insert::Error occured.", ex);
			}
			finally
			{
				// Close connection.
        ...
        //
        //
        public DataTable pr_TongMucTieuHaiQuan(DateTime ngay_batdau, DateTime ngay_ketthuc, string keySearch)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_TongMucTieuHaiQuan]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_TongMucTieuHaiQuan");
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_TongMucTieuHaiQuan", ex);
            }
            finally
            {
                //Close connection.
        ...
        //
        //
        public DataTable pr_SelecHaiQuan_QuanSu_MyVBB(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_SelecHaiQuan_QuanSu_MyVBB]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_SelecHaiQuan_QuanSu_MyVBB");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_SelecHaiQuan_QuanSu_MyVBB", ex);
            }
            finally
            {
                //Close connection.
        ...
        //
        public DataTable pr_SelecHaiQuan_NCKS_MyVBB(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_SelecHaiQuan_NCKS_MyVBB]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_SelecHaiQuan_NCKS_MyVBB");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_SelecHaiQuan_NCKS_MyVBB", ex);
            }
            finally
            {
                //Close connection.
        ...
        //
        //
        public DataTable pr_SelecHaiQuan_ChapPhap_MyVBB(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_SelecHaiQuan_ChapPhap_MyVBB]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_SelecHaiQuan_ChapPhap_MyVBB");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_SelecHaiQuan_ChapPhap_MyVBB", ex);
            }
            finally
            {
                //Close connection.
        ...
        //
        //
        public DataTable pr_SelecHaiQuan_ChapPhap_TQVBB(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_SelecHaiQuan_ChapPhap_TQVBB]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_SelecHaiQuan_ChapPhap_TQVBB");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_SelecHaiQuan_ChapPhap_TQVBB", ex);
            }
            finally
            {
                //Close connection.
        ...
        //
        public DataTable pr_SelecHaiQuan_QuanSu_TQVBB(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_SelecHaiQuan_QuanSu_TQVBB]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_SelecHaiQuan_QuanSu_TQVBB");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_SelecHaiQuan_QuanSu_TQVBB", ex);
            }
            finally
            {
                //Close connection.
        ...
        //
        public DataTable pr_SelecHaiQuan_NCKS_TQVBB(DateTime ngay_batdau, DateTime ngay_ketthuc)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_SelecHaiQuan_NCKS_TQVBB]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_SelecHaiQuan_NCKS_TQVBB");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_SelecHaiQuan_NCKS_TQVBB", ex);
            }
            finally
            {
                //Close connection.
        ...
        //
        public DataTable pr_SelecPageHaiQuan(int sotrang, DateTime ngay_batdau, DateTime ngay_ketthuc, string keySearch)
        {
            SqlCommand scmCmdToExecute = new SqlCommand();
            scmCmdToExecute.CommandText = "dbo.[pr_SelecPageHaiQuan]";
            scmCmdToExecute.CommandType = CommandType.StoredProcedure;
            DataTable dtToReturn = new DataTable("pr_SelecPageHaiQuan");
            SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
            ...
            {
                // some error occured. Bubble it to caller and encapsulate Exception object
                throw new Exception("pr_SelecPageHaiQuan", ex);
            }
            finally
            {
                //Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_tabHaiQuan_Update]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsTabHaiQuan::Update::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_tabHaiQuan_Delete]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsTabHaiQuan::Delete::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_tabHaiQuan_SelectOne]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("tabHaiQuan");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsTabHaiQuan::SelectOne::Error occured.", ex);
			}
			finally
			{
				// Close connection.
		...
		{
			SqlCommand	scmCmdToExecute = new SqlCommand();
			scmCmdToExecute.CommandText = "dbo.[pr_tabHaiQuan_SelectAll]";
			scmCmdToExecute.CommandType = CommandType.StoredProcedure;
			DataTable dtToReturn = new DataTable("tabHaiQuan");
			SqlDataAdapter sdaAdapter = new SqlDataAdapter(scmCmdToExecute);
			...
			{
				// some error occured. Bubble it to caller and encapsulate Exception object
				throw new Exception("clsTabHaiQuan::SelectAll::Error occured.", ex);
			}
			finally
			{
				// Close connection.
